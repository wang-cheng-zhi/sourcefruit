...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		 ...
		 *    'display index' if you have hidden data 条数
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 *  @example
	...
	DataTable.defaults = {
		...
		/**
		 * This parameter allows you to readily specify the 条数 in the length drop
		 ...
		 * (i.e. "展示 57 条中的 1 到 10 条") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default 共 _TOTAL_ 条，显示 _START_ 到 _END_ 条
			 *
			 *  @dtopt Language
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the '展示 x of y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
